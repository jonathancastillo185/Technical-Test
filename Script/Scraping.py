...
if __name__ == "__main__":
    ...
    print_process("Base de datos Peliculas_Series_completo_Respaldo.csv se exporto correctamente")
    ...
    print_process("Base de datos Peliculas.csv se exporto correctamente")
    ...
    print_process("Base de datos Peliculas_dummies.csv se exporto correctamente")
